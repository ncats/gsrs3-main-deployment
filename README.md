...
- In GSRS 3.1.2, there were changes to the Impurities microservice database schema.  Before upgrading your system, please check the [release notes](./docs/release%20notes) for discussion. Also please check the README files in [./impurities/database/](/ncats/gsrs3-main-deployment/tree/main/impurities/database/) for suggested steps.
