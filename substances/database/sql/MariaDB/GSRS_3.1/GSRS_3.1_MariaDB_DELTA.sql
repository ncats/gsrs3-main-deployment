...
alter table ix_core_key_user_list add constraint ukq0ipvkfn4lc8e88hi3900bytv unique (entity_key, list_name, user_id, kind);
...
alter table ix_core_user_saved_list add constraint ukg72w8umh72yn9lnpxxycln5jd unique (name, user_id, kind);
