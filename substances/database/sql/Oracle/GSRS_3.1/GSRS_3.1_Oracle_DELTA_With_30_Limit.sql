...
create index idx_import_data_class_name on ix_import_data (entity_class_name);
create index idx_import_data_version on ix_import_data (version);
create index idx_import_data_record_id on ix_import_data (record_id);
create index idx_import_mapping_key on ix_import_mapping (mapping_key);
create index idx_import_mapping_value on ix_import_mapping (mapping_value);
create index idx_import_mapping_instance_id on ix_import_mapping (instance_id);
create index idx_import_metadata_class_name on ix_import_metadata (entity_class_name);
create index idx_import_validation_class_nm on ix_import_validation (entity_class_name);
create index idx_import_validation_version on ix_import_validation (version);
create index idx_import_validtn_instance_id on ix_import_validation (instance_id);
